...
from src.infrastructure.settings.logger import configurar_logger, configurar_logging_ngrok

# --- Tests para HttpxClient ---
@pytest.mark.asyncio
...
def test_configurar_logging_ngrok_con_handler():
    # Setup
    ...
    # Action
    configurar_logging_ngrok(mock_logger)
    
    # Verify
    logger_ngrok = logging.getLogger("pyngrok")
    assert mock_handler in logger_ngrok.handlers
